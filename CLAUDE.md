...
| **`db:reset` destroys Zitadel eventstore**            | Shared postgres volume means `down -v` wipes Zitadel schemas. After reset: restart Zitadel container, re-run `pnpm zitadel:setup`, restart dev servers. Backlog item to fix properly |

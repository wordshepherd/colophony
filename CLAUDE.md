...
| **`gh pr create` burns GraphQL rate limit**           | `gh pr create/list/view` use GraphQL (5000 pts/hr shared across all OAuth apps for the user). Use REST instead: `gh api repos/{owner}/{repo}/pulls -X POST -f title="..." -f head="..." -f base="..." -f body="..."`. Diagnosed 2026-02-19 — source of exhaustion still under investigation |

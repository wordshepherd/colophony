...
from ...models.get_submission_analytics_status_breakdown_response_200 import (
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/submissions/analytics/status-breakdown",
        "params": params,
    }
...
) -> GetSubmissionAnalyticsStatusBreakdownResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSubmissionAnalyticsStatusBreakdownResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetSubmissionAnalyticsStatusBreakdownResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Submission status breakdown
     ...
     Returns the count of submissions grouped by status.

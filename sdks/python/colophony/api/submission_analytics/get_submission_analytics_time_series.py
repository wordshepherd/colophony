...
from ...models.get_submission_analytics_time_series_granularity import GetSubmissionAnalyticsTimeSeriesGranularity
from ...models.get_submission_analytics_time_series_response_200 import GetSubmissionAnalyticsTimeSeriesResponse200
...
def _get_kwargs(
    *,
    ...
    granularity: GetSubmissionAnalyticsTimeSeriesGranularity
    | Unset = GetSubmissionAnalyticsTimeSeriesGranularity.MONTHLY,
) -> dict[str, Any]:
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/submissions/analytics/time-series",
        "params": params,
    }
...
) -> GetSubmissionAnalyticsTimeSeriesResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSubmissionAnalyticsTimeSeriesResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetSubmissionAnalyticsTimeSeriesResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        granularity (GetSubmissionAnalyticsTimeSeriesGranularity | Unset):  Default:
            GetSubmissionAnalyticsTimeSeriesGranularity.MONTHLY.

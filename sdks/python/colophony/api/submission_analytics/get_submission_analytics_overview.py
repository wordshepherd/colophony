...
from ...models.get_submission_analytics_overview_response_200 import GetSubmissionAnalyticsOverviewResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/submissions/analytics/overview",
        "params": params,
    }
...
) -> GetSubmissionAnalyticsOverviewResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSubmissionAnalyticsOverviewResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetSubmissionAnalyticsOverviewResponse200]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Submission analytics overview
     ...
     Returns key submission statistics: totals, acceptance rate, avg response time, and month-over-month
    counts.

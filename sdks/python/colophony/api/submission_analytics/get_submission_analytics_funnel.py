...
from ...models.get_submission_analytics_funnel_response_200 import GetSubmissionAnalyticsFunnelResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/submissions/analytics/funnel",
        "params": params,
    }
...
) -> GetSubmissionAnalyticsFunnelResponse200 | None:
    if response.status_code == 200:
        response_200 = GetSubmissionAnalyticsFunnelResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetSubmissionAnalyticsFunnelResponse200]:
    return Response(

...
from ..models.update_pipeline_stage_response_200_stage import UpdatePipelineStageResponse200Stage
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.update_pipeline_stage_response_200_assigned_copyeditor import UpdatePipelineStageResponse200AssignedCopyeditor
  from ..models.update_pipeline_stage_response_200_assigned_proofreader import UpdatePipelineStageResponse200AssignedProofreader
  from ..models.update_pipeline_stage_response_200_publication import UpdatePipelineStageResponse200Publication
  from ..models.update_pipeline_stage_response_200_submission import UpdatePipelineStageResponse200Submission





T = TypeVar("T", bound="UpdatePipelineStageResponse200")



@_attrs_define
class UpdatePipelineStageResponse200:
    """ 
        Attributes:
            ...
            stage (UpdatePipelineStageResponse200Stage): Current pipeline stage for the piece
            ...
            submission (UpdatePipelineStageResponse200Submission | Unset):
            publication (UpdatePipelineStageResponse200Publication | Unset):
            assigned_copyeditor (UpdatePipelineStageResponse200AssignedCopyeditor | Unset):
            assigned_proofreader (UpdatePipelineStageResponse200AssignedProofreader | Unset):
     """
    ...
    stage: UpdatePipelineStageResponse200Stage
    ...
    submission: UpdatePipelineStageResponse200Submission | Unset = UNSET
    publication: UpdatePipelineStageResponse200Publication | Unset = UNSET
    assigned_copyeditor: UpdatePipelineStageResponse200AssignedCopyeditor | Unset = UNSET
    assigned_proofreader: UpdatePipelineStageResponse200AssignedProofreader | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stage = UpdatePipelineStageResponse200Stage(d.pop("stage"))
        ...
        if isinstance(_submission,  Unset):
            ...
            submission = UpdatePipelineStageResponse200Submission.from_dict(_submission)
        ...
        if isinstance(_publication,  Unset):
            ...
            publication = UpdatePipelineStageResponse200Publication.from_dict(_publication)
        ...
        if isinstance(_assigned_copyeditor,  Unset):
            ...
            assigned_copyeditor = UpdatePipelineStageResponse200AssignedCopyeditor.from_dict(_assigned_copyeditor)
        ...
        if isinstance(_assigned_proofreader,  Unset):
            ...
            assigned_proofreader = UpdatePipelineStageResponse200AssignedProofreader.from_dict(_assigned_proofreader)




        update_pipeline_stage_response_200 = cls(
            id=id,
        ...
        update_pipeline_stage_response_200.additional_properties = d
        return update_pipeline_stage_response_200

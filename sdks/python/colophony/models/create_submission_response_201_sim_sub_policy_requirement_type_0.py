...
from ..models.create_submission_response_201_sim_sub_policy_requirement_type_0_type import (
    CreateSubmissionResponse201SimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateSubmissionResponse201SimSubPolicyRequirementType0")


@_attrs_define
class CreateSubmissionResponse201SimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (CreateSubmissionResponse201SimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = CreateSubmissionResponse201SimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        create_submission_response_201_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        create_submission_response_201_sim_sub_policy_requirement_type_0.additional_properties = d
        return create_submission_response_201_sim_sub_policy_requirement_type_0

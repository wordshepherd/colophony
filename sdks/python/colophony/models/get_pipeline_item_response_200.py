...
from ..models.get_pipeline_item_response_200_stage import GetPipelineItemResponse200Stage
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_pipeline_item_response_200_assigned_copyeditor import GetPipelineItemResponse200AssignedCopyeditor
    from ..models.get_pipeline_item_response_200_assigned_proofreader import (
        GetPipelineItemResponse200AssignedProofreader,
    )
    from ..models.get_pipeline_item_response_200_publication import GetPipelineItemResponse200Publication
    from ..models.get_pipeline_item_response_200_submission import GetPipelineItemResponse200Submission


T = TypeVar("T", bound="GetPipelineItemResponse200")


@_attrs_define
class GetPipelineItemResponse200:
    """
    Attributes:
        ...
        stage (GetPipelineItemResponse200Stage): Current pipeline stage for the piece
        ...
        submission (GetPipelineItemResponse200Submission | Unset):
        publication (GetPipelineItemResponse200Publication | Unset):
        assigned_copyeditor (GetPipelineItemResponse200AssignedCopyeditor | Unset):
        assigned_proofreader (GetPipelineItemResponse200AssignedProofreader | Unset):
    """
    ...
    stage: GetPipelineItemResponse200Stage
    ...
    submission: GetPipelineItemResponse200Submission | Unset = UNSET
    publication: GetPipelineItemResponse200Publication | Unset = UNSET
    assigned_copyeditor: GetPipelineItemResponse200AssignedCopyeditor | Unset = UNSET
    assigned_proofreader: GetPipelineItemResponse200AssignedProofreader | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_pipeline_item_response_200_assigned_copyeditor import (
        ...
        stage = GetPipelineItemResponse200Stage(d.pop("stage"))
        ...
        if isinstance(_submission, Unset):
            ...
            submission = GetPipelineItemResponse200Submission.from_dict(_submission)
        ...
        if isinstance(_publication, Unset):
            ...
            publication = GetPipelineItemResponse200Publication.from_dict(_publication)
        ...
        if isinstance(_assigned_copyeditor, Unset):
            ...
            assigned_copyeditor = GetPipelineItemResponse200AssignedCopyeditor.from_dict(_assigned_copyeditor)
        ...
        if isinstance(_assigned_proofreader, Unset):
            ...
            assigned_proofreader = GetPipelineItemResponse200AssignedProofreader.from_dict(_assigned_proofreader)

        get_pipeline_item_response_200 = cls(
            id=id,
        ...
        get_pipeline_item_response_200.additional_properties = d
        return get_pipeline_item_response_200

...
from ..models.list_my_submissions_response_200_items_item_sim_sub_policy_requirement_type_0_type import (
    ListMySubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListMySubmissionsResponse200ItemsItemSimSubPolicyRequirementType0")


@_attrs_define
class ListMySubmissionsResponse200ItemsItemSimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (ListMySubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = ListMySubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        list_my_submissions_response_200_items_item_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        list_my_submissions_response_200_items_item_sim_sub_policy_requirement_type_0.additional_properties = d
        return list_my_submissions_response_200_items_item_sim_sub_policy_requirement_type_0

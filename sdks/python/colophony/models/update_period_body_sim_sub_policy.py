...
from ..models.update_period_body_sim_sub_policy_type import UpdatePeriodBodySimSubPolicyType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_period_body_sim_sub_policy_genre_overrides_item import (
        UpdatePeriodBodySimSubPolicyGenreOverridesItem,
    )


T = TypeVar("T", bound="UpdatePeriodBodySimSubPolicy")


@_attrs_define
class UpdatePeriodBodySimSubPolicy:
    """Sim-sub policy (default: allowed)

    Attributes:
        type_ (UpdatePeriodBodySimSubPolicyType):
        notify_window_hours (int | Unset):
        genre_overrides (list[UpdatePeriodBodySimSubPolicyGenreOverridesItem] | Unset):
        notes (str | Unset):
    """

    type_: UpdatePeriodBodySimSubPolicyType
    notify_window_hours: int | Unset = UNSET
    genre_overrides: list[UpdatePeriodBodySimSubPolicyGenreOverridesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = UpdatePeriodBodySimSubPolicyType(d.pop("type"))
        ...
        if _genre_overrides is not UNSET:
            ...
            for genre_overrides_item_data in _genre_overrides:
                genre_overrides_item = UpdatePeriodBodySimSubPolicyGenreOverridesItem.from_dict(
        ...
        update_period_body_sim_sub_policy = cls(
            type_=type_,
        ...
        update_period_body_sim_sub_policy.additional_properties = d
        return update_period_body_sim_sub_policy

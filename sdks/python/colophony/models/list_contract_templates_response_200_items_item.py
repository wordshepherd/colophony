...
if TYPE_CHECKING:
    from ..models.list_contract_templates_response_200_items_item_merge_fields_type_0_item import (
...
class ListContractTemplatesResponse200ItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_merge_fields(
            data: object,
        ) -> list[ListContractTemplatesResponse200ItemsItemMergeFieldsType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for merge_fields_type_0_item_data in _merge_fields_type_0:
                    merge_fields_type_0_item = ListContractTemplatesResponse200ItemsItemMergeFieldsType0Item.from_dict(

...
if TYPE_CHECKING:
    from ..models.list_collections_response_200_items_item import ListCollectionsResponse200ItemsItem
...
class ListCollectionsResponse200:
    """
    Attributes:
        items (list[ListCollectionsResponse200ItemsItem]): Items on the current page
    ...
    items: list[ListCollectionsResponse200ItemsItem]
    total: float
    page: float
    limit: float
    total_pages: float
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in _items:
            items_item = ListCollectionsResponse200ItemsItem.from_dict(items_item_data)

...
T = TypeVar("T", bound="UpdateManuscriptResponse200")



@_attrs_define
class UpdateManuscriptResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_manuscript_response_200 = cls(
            id=id,
            owner_id=owner_id,
            title=title,
            description=description,
        ...
        update_manuscript_response_200.additional_properties = d
        return update_manuscript_response_200

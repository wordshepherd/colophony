...
from ..models.assign_pipeline_copyeditor_response_200_stage import AssignPipelineCopyeditorResponse200Stage
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.assign_pipeline_copyeditor_response_200_assigned_copyeditor import AssignPipelineCopyeditorResponse200AssignedCopyeditor
  from ..models.assign_pipeline_copyeditor_response_200_assigned_proofreader import AssignPipelineCopyeditorResponse200AssignedProofreader
  from ..models.assign_pipeline_copyeditor_response_200_publication import AssignPipelineCopyeditorResponse200Publication
  from ..models.assign_pipeline_copyeditor_response_200_submission import AssignPipelineCopyeditorResponse200Submission





T = TypeVar("T", bound="AssignPipelineCopyeditorResponse200")



@_attrs_define
class AssignPipelineCopyeditorResponse200:
    """ 
        Attributes:
            ...
            stage (AssignPipelineCopyeditorResponse200Stage): Current pipeline stage for the piece
            ...
            submission (AssignPipelineCopyeditorResponse200Submission | Unset):
            publication (AssignPipelineCopyeditorResponse200Publication | Unset):
            assigned_copyeditor (AssignPipelineCopyeditorResponse200AssignedCopyeditor | Unset):
            assigned_proofreader (AssignPipelineCopyeditorResponse200AssignedProofreader | Unset):
     """
    ...
    stage: AssignPipelineCopyeditorResponse200Stage
    ...
    submission: AssignPipelineCopyeditorResponse200Submission | Unset = UNSET
    publication: AssignPipelineCopyeditorResponse200Publication | Unset = UNSET
    assigned_copyeditor: AssignPipelineCopyeditorResponse200AssignedCopyeditor | Unset = UNSET
    assigned_proofreader: AssignPipelineCopyeditorResponse200AssignedProofreader | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stage = AssignPipelineCopyeditorResponse200Stage(d.pop("stage"))
        ...
        if isinstance(_submission,  Unset):
            ...
            submission = AssignPipelineCopyeditorResponse200Submission.from_dict(_submission)
        ...
        if isinstance(_publication,  Unset):
            ...
            publication = AssignPipelineCopyeditorResponse200Publication.from_dict(_publication)
        ...
        if isinstance(_assigned_copyeditor,  Unset):
            ...
            assigned_copyeditor = AssignPipelineCopyeditorResponse200AssignedCopyeditor.from_dict(_assigned_copyeditor)
        ...
        if isinstance(_assigned_proofreader,  Unset):
            ...
            assigned_proofreader = AssignPipelineCopyeditorResponse200AssignedProofreader.from_dict(_assigned_proofreader)




        assign_pipeline_copyeditor_response_200 = cls(
            id=id,
        ...
        assign_pipeline_copyeditor_response_200.additional_properties = d
        return assign_pipeline_copyeditor_response_200

...
if TYPE_CHECKING:
    from ..models.assign_pipeline_copyeditor_response_200_assigned_copyeditor import (
        AssignPipelineCopyeditorResponse200AssignedCopyeditor,
    )
    from ..models.assign_pipeline_copyeditor_response_200_assigned_proofreader import (
        AssignPipelineCopyeditorResponse200AssignedProofreader,
    )
    from ..models.assign_pipeline_copyeditor_response_200_publication import (
        AssignPipelineCopyeditorResponse200Publication,
    )
    from ..models.assign_pipeline_copyeditor_response_200_submission import (
...
class AssignPipelineCopyeditorResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_assigned_proofreader, Unset):
            ...
            assigned_proofreader = AssignPipelineCopyeditorResponse200AssignedProofreader.from_dict(

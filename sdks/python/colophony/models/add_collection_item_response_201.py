...
T = TypeVar("T", bound="AddCollectionItemResponse201")


@_attrs_define
class AddCollectionItemResponse201:
    """
    Attributes:
        id (UUID): Item ID
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_collection_item_response_201 = cls(
            id=id,
        ...
        add_collection_item_response_201.additional_properties = d
        return add_collection_item_response_201

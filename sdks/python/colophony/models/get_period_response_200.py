...
from ..models.get_period_response_200_blind_review_mode import GetPeriodResponse200BlindReviewMode

if TYPE_CHECKING:
    from ..models.get_period_response_200_sim_sub_policy import GetPeriodResponse200SimSubPolicy


T = TypeVar("T", bound="GetPeriodResponse200")


@_attrs_define
class GetPeriodResponse200:
    """
    Attributes:
        ...
        sim_sub_policy (GetPeriodResponse200SimSubPolicy): Sim-sub policy for this period
        blind_review_mode (GetPeriodResponse200BlindReviewMode): Blind review mode for the submission period
    ...
    sim_sub_policy: GetPeriodResponse200SimSubPolicy
    blind_review_mode: GetPeriodResponse200BlindReviewMode
    is_contest: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sim_sub_policy = GetPeriodResponse200SimSubPolicy.from_dict(d.pop("simSubPolicy"))

        blind_review_mode = GetPeriodResponse200BlindReviewMode(d.pop("blindReviewMode"))
        ...
        get_period_response_200.additional_properties = d
        return get_period_response_200

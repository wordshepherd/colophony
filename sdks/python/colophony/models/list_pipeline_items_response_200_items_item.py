...
from ..models.list_pipeline_items_response_200_items_item_stage import ListPipelineItemsResponse200ItemsItemStage
from ..types import UNSET, Unset
...
if TYPE_CHECKING:
  from ..models.list_pipeline_items_response_200_items_item_assigned_copyeditor import ListPipelineItemsResponse200ItemsItemAssignedCopyeditor
  from ..models.list_pipeline_items_response_200_items_item_assigned_proofreader import ListPipelineItemsResponse200ItemsItemAssignedProofreader
  from ..models.list_pipeline_items_response_200_items_item_publication import ListPipelineItemsResponse200ItemsItemPublication
  from ..models.list_pipeline_items_response_200_items_item_submission import ListPipelineItemsResponse200ItemsItemSubmission





T = TypeVar("T", bound="ListPipelineItemsResponse200ItemsItem")



@_attrs_define
class ListPipelineItemsResponse200ItemsItem:
    """ 
        Attributes:
            ...
            stage (ListPipelineItemsResponse200ItemsItemStage): Current pipeline stage for the piece
            ...
            submission (ListPipelineItemsResponse200ItemsItemSubmission | Unset):
            publication (ListPipelineItemsResponse200ItemsItemPublication | Unset):
            assigned_copyeditor (ListPipelineItemsResponse200ItemsItemAssignedCopyeditor | Unset):
            assigned_proofreader (ListPipelineItemsResponse200ItemsItemAssignedProofreader | Unset):
     """
    ...
    stage: ListPipelineItemsResponse200ItemsItemStage
    ...
    submission: ListPipelineItemsResponse200ItemsItemSubmission | Unset = UNSET
    publication: ListPipelineItemsResponse200ItemsItemPublication | Unset = UNSET
    assigned_copyeditor: ListPipelineItemsResponse200ItemsItemAssignedCopyeditor | Unset = UNSET
    assigned_proofreader: ListPipelineItemsResponse200ItemsItemAssignedProofreader | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stage = ListPipelineItemsResponse200ItemsItemStage(d.pop("stage"))
        ...
        if isinstance(_submission,  Unset):
            ...
            submission = ListPipelineItemsResponse200ItemsItemSubmission.from_dict(_submission)
        ...
        if isinstance(_publication,  Unset):
            ...
            publication = ListPipelineItemsResponse200ItemsItemPublication.from_dict(_publication)
        ...
        if isinstance(_assigned_copyeditor,  Unset):
            ...
            assigned_copyeditor = ListPipelineItemsResponse200ItemsItemAssignedCopyeditor.from_dict(_assigned_copyeditor)
        ...
        if isinstance(_assigned_proofreader,  Unset):
            ...
            assigned_proofreader = ListPipelineItemsResponse200ItemsItemAssignedProofreader.from_dict(_assigned_proofreader)




        list_pipeline_items_response_200_items_item = cls(
            id=id,
        ...
        list_pipeline_items_response_200_items_item.additional_properties = d
        return list_pipeline_items_response_200_items_item

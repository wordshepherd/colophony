...
if TYPE_CHECKING:
    from ..models.list_pipeline_items_response_200_items_item_assigned_copyeditor import (
        ListPipelineItemsResponse200ItemsItemAssignedCopyeditor,
    )
    from ..models.list_pipeline_items_response_200_items_item_assigned_proofreader import (
        ListPipelineItemsResponse200ItemsItemAssignedProofreader,
    )
    from ..models.list_pipeline_items_response_200_items_item_publication import (
        ListPipelineItemsResponse200ItemsItemPublication,
    )
    from ..models.list_pipeline_items_response_200_items_item_submission import (
...
class ListPipelineItemsResponse200ItemsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_assigned_copyeditor, Unset):
            ...
            assigned_copyeditor = ListPipelineItemsResponse200ItemsItemAssignedCopyeditor.from_dict(
                _assigned_copyeditor
            )
        ...
        if isinstance(_assigned_proofreader, Unset):
            ...
            assigned_proofreader = ListPipelineItemsResponse200ItemsItemAssignedProofreader.from_dict(
                _assigned_proofreader
            )

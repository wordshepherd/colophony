...
from ..models.update_submission_response_200_sim_sub_policy_requirement_type_0_type import (
    UpdateSubmissionResponse200SimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateSubmissionResponse200SimSubPolicyRequirementType0")


@_attrs_define
class UpdateSubmissionResponse200SimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (UpdateSubmissionResponse200SimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = UpdateSubmissionResponse200SimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        update_submission_response_200_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        update_submission_response_200_sim_sub_policy_requirement_type_0.additional_properties = d
        return update_submission_response_200_sim_sub_policy_requirement_type_0

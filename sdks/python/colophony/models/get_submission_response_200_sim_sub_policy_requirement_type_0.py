...
from ..models.get_submission_response_200_sim_sub_policy_requirement_type_0_type import (
    GetSubmissionResponse200SimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetSubmissionResponse200SimSubPolicyRequirementType0")


@_attrs_define
class GetSubmissionResponse200SimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (GetSubmissionResponse200SimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = GetSubmissionResponse200SimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        get_submission_response_200_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        get_submission_response_200_sim_sub_policy_requirement_type_0.additional_properties = d
        return get_submission_response_200_sim_sub_policy_requirement_type_0

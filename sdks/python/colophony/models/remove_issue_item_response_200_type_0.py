...
T = TypeVar("T", bound="RemoveIssueItemResponse200Type0")


@_attrs_define
class RemoveIssueItemResponse200Type0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_issue_item_response_200_type_0 = cls(
            id=id,
            issue_id=issue_id,
        ...
        remove_issue_item_response_200_type_0.additional_properties = d
        return remove_issue_item_response_200_type_0

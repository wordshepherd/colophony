...
from ..models.duplicate_form_response_201_fields_item_conditional_rules_type_0_item_condition_operator import (
    DuplicateFormResponse201FieldsItemConditionalRulesType0ItemConditionOperator,
)

if TYPE_CHECKING:
    from ..models.duplicate_form_response_201_fields_item_conditional_rules_type_0_item_condition_rules_item import (
...
class DuplicateFormResponse201FieldsItemConditionalRulesType0ItemCondition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rules_item_data in _rules:
            rules_item = DuplicateFormResponse201FieldsItemConditionalRulesType0ItemConditionRulesItem.from_dict(
                rules_item_data
            )

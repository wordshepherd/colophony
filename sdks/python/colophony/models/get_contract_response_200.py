...
from ..models.get_contract_response_200_status import GetContractResponse200Status

if TYPE_CHECKING:
    from ..models.get_contract_response_200_merge_data_type_0 import GetContractResponse200MergeDataType0
...
class GetContractResponse200:
    ...
    Attributes:
        ...
        status (GetContractResponse200Status): Current status of the contract
        rendered_body (str): Contract body with merge fields resolved
        merge_data (GetContractResponse200MergeDataType0 | None): Merge field values used
    ...
    status: GetContractResponse200Status
    rendered_body: str
    merge_data: GetContractResponse200MergeDataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.merge_data, GetContractResponse200MergeDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetContractResponse200Status(d.pop("status"))

        rendered_body = d.pop("renderedBody")

        def _parse_merge_data(data: object) -> GetContractResponse200MergeDataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                merge_data_type_0 = GetContractResponse200MergeDataType0.from_dict(data)

                return merge_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetContractResponse200MergeDataType0 | None, data)

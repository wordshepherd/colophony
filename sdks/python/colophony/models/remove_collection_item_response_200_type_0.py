...
T = TypeVar("T", bound="RemoveCollectionItemResponse200Type0")


@_attrs_define
class RemoveCollectionItemResponse200Type0:
    """
    Attributes:
        id (UUID): Item ID
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        remove_collection_item_response_200_type_0 = cls(
            id=id,
        ...
        remove_collection_item_response_200_type_0.additional_properties = d
        return remove_collection_item_response_200_type_0

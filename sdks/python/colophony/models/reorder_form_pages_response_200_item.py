...
if TYPE_CHECKING:
  from ..models.reorder_form_pages_response_200_item_branching_rules_type_0_item import ReorderFormPagesResponse200ItemBranchingRulesType0Item





T = TypeVar("T", bound="ReorderFormPagesResponse200Item")



@_attrs_define
class ReorderFormPagesResponse200Item:
    """ 
        Attributes:
            id (UUID):
            ...
            sort_order (int):
            branching_rules (list[ReorderFormPagesResponse200ItemBranchingRulesType0Item] | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branching_rules(data: object) -> list[ReorderFormPagesResponse200ItemBranchingRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for branching_rules_type_0_item_data in (_branching_rules_type_0):
                    branching_rules_type_0_item = ReorderFormPagesResponse200ItemBranchingRulesType0Item.from_dict(branching_rules_type_0_item_data)
                ...
                pass
            return cast(list[ReorderFormPagesResponse200ItemBranchingRulesType0Item] | None, data)
        ...
        reorder_form_pages_response_200_item = cls(
            id=id,
        ...
        reorder_form_pages_response_200_item.additional_properties = d
        return reorder_form_pages_response_200_item

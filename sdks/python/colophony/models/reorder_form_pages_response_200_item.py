...
if TYPE_CHECKING:
    from ..models.reorder_form_pages_response_200_item_branching_rules_type_0_item import (
        ...
        def _parse_branching_rules(data: object) -> list[ReorderFormPagesResponse200ItemBranchingRulesType0Item] | None:
            ...
            try:
                ...
                for branching_rules_type_0_item_data in _branching_rules_type_0:
                    branching_rules_type_0_item = ReorderFormPagesResponse200ItemBranchingRulesType0Item.from_dict(

...
from ..models.archive_form_response_200_status import ArchiveFormResponse200Status
...
T = TypeVar("T", bound="ArchiveFormResponse200")



@_attrs_define
class ArchiveFormResponse200:
    """ 
        Attributes:
            ...
            status (ArchiveFormResponse200Status): Current status of the form definition
    ...
    status: ArchiveFormResponse200Status
    version: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ArchiveFormResponse200Status(d.pop("status"))
        ...
        archive_form_response_200.additional_properties = d
        return archive_form_response_200

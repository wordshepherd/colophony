...
from ..models.list_submissions_response_200_items_item_sim_sub_policy_requirement_type_0_type import (
    ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0")


@_attrs_define
class ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        list_submissions_response_200_items_item_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        list_submissions_response_200_items_item_sim_sub_policy_requirement_type_0.additional_properties = d
        return list_submissions_response_200_items_item_sim_sub_policy_requirement_type_0

...
T = TypeVar("T", bound="ListSubmissionDiscussionsResponse200Item")


@_attrs_define
class ListSubmissionDiscussionsResponse200Item:
    """
    Attributes:
        id (UUID):
        submission_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_submission_discussions_response_200_item = cls(
            id=id,
        ...
        list_submission_discussions_response_200_item.additional_properties = d
        return list_submission_discussions_response_200_item

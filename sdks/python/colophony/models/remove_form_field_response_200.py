...
if TYPE_CHECKING:
    from ..models.remove_form_field_response_200_conditional_rules_type_0_item import (
        ...
        def _parse_conditional_rules(data: object) -> list[RemoveFormFieldResponse200ConditionalRulesType0Item] | None:
            ...
            try:
                ...
                for conditional_rules_type_0_item_data in _conditional_rules_type_0:
                    conditional_rules_type_0_item = RemoveFormFieldResponse200ConditionalRulesType0Item.from_dict(

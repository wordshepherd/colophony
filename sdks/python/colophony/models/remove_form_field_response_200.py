...
from ..models.remove_form_field_response_200_field_type import RemoveFormFieldResponse200FieldType
...
if TYPE_CHECKING:
  from ..models.remove_form_field_response_200_conditional_rules_type_0_item import RemoveFormFieldResponse200ConditionalRulesType0Item
  from ..models.remove_form_field_response_200_config_type_0 import RemoveFormFieldResponse200ConfigType0





T = TypeVar("T", bound="RemoveFormFieldResponse200")



@_attrs_define
class RemoveFormFieldResponse200:
    """ 
        Attributes:
            ...
            field_type (RemoveFormFieldResponse200FieldType): Type of form field
            ...
            config (None | RemoveFormFieldResponse200ConfigType0): Type-specific configuration for the field
            conditional_rules (list[RemoveFormFieldResponse200ConditionalRulesType0Item] | None): Conditional display rules
    ...
    field_key: str
    field_type: RemoveFormFieldResponse200FieldType
    label: str
    description: None | str
    placeholder: None | str
    required: bool
    sort_order: int
    config: None | RemoveFormFieldResponse200ConfigType0
    conditional_rules: list[RemoveFormFieldResponse200ConditionalRulesType0Item] | None
    branch_id: None | str
    page_id: None | UUID
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, RemoveFormFieldResponse200ConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_type = RemoveFormFieldResponse200FieldType(d.pop("fieldType"))
        ...
        def _parse_config(data: object) -> None | RemoveFormFieldResponse200ConfigType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = RemoveFormFieldResponse200ConfigType0.from_dict(data)
                ...
                pass
            return cast(None | RemoveFormFieldResponse200ConfigType0, data)

        config = _parse_config(d.pop("config"))


        def _parse_conditional_rules(data: object) -> list[RemoveFormFieldResponse200ConditionalRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for conditional_rules_type_0_item_data in (_conditional_rules_type_0):
                    conditional_rules_type_0_item = RemoveFormFieldResponse200ConditionalRulesType0Item.from_dict(conditional_rules_type_0_item_data)
                ...
                pass
            return cast(list[RemoveFormFieldResponse200ConditionalRulesType0Item] | None, data)
        ...
        remove_form_field_response_200 = cls(
            id=id,
        ...
        remove_form_field_response_200.additional_properties = d
        return remove_form_field_response_200

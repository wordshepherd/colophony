...
T = TypeVar("T", bound="ReorderIssueItemsResponse200Item")



@_attrs_define
class ReorderIssueItemsResponse200Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reorder_issue_items_response_200_item = cls(
            id=id,
            issue_id=issue_id,
        ...
        reorder_issue_items_response_200_item.additional_properties = d
        return reorder_issue_items_response_200_item

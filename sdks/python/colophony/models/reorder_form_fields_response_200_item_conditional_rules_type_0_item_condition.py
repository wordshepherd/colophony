...
from ..models.reorder_form_fields_response_200_item_conditional_rules_type_0_item_condition_operator import (
    ReorderFormFieldsResponse200ItemConditionalRulesType0ItemConditionOperator,
)

if TYPE_CHECKING:
    from ..models.reorder_form_fields_response_200_item_conditional_rules_type_0_item_condition_rules_item import (
...
class ReorderFormFieldsResponse200ItemConditionalRulesType0ItemCondition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rules_item_data in _rules:
            rules_item = ReorderFormFieldsResponse200ItemConditionalRulesType0ItemConditionRulesItem.from_dict(
                rules_item_data
            )

...
T = TypeVar("T", bound="GetAuditEventResponse200")



@_attrs_define
class GetAuditEventResponse200:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_audit_event_response_200 = cls(
            id=id,
            action=action,
            resource=resource,
        ...
        get_audit_event_response_200.additional_properties = d
        return get_audit_event_response_200

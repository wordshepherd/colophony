...
if TYPE_CHECKING:
  from ..models.list_api_keys_response_200_items_item import ListApiKeysResponse200ItemsItem
...
class ListApiKeysResponse200:
    """ 
        Attributes:
            items (list[ListApiKeysResponse200ItemsItem]): Items on the current page
    ...
    items: list[ListApiKeysResponse200ItemsItem]
    total: float
    page: float
    limit: float
    total_pages: float
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for items_item_data in (_items):
            items_item = ListApiKeysResponse200ItemsItem.from_dict(items_item_data)

...
class ListIssuesResponse200ItemsItem:
    ...
    status: ListIssuesResponse200ItemsItemStatus
    publication_date: datetime.datetime | None
    published_at: datetime.datetime | None
    metadata: ListIssuesResponse200ItemsItemMetadataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, ListIssuesResponse200ItemsItemMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_metadata(data: object) -> ListIssuesResponse200ItemsItemMetadataType0 | None:
            ...
            try:
                ...
                pass
            return cast(ListIssuesResponse200ItemsItemMetadataType0 | None, data)

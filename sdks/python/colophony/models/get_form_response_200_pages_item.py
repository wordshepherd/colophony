...
if TYPE_CHECKING:
    from ..models.get_form_response_200_pages_item_branching_rules_type_0_item import (
        ...
        def _parse_branching_rules(data: object) -> list[GetFormResponse200PagesItemBranchingRulesType0Item] | None:
            ...
            try:
                ...
                for branching_rules_type_0_item_data in _branching_rules_type_0:
                    branching_rules_type_0_item = GetFormResponse200PagesItemBranchingRulesType0Item.from_dict(

...
if TYPE_CHECKING:
  from ..models.get_form_response_200_pages_item_branching_rules_type_0_item import GetFormResponse200PagesItemBranchingRulesType0Item





T = TypeVar("T", bound="GetFormResponse200PagesItem")



@_attrs_define
class GetFormResponse200PagesItem:
    """ 
        Attributes:
            id (UUID):
            ...
            sort_order (int):
            branching_rules (list[GetFormResponse200PagesItemBranchingRulesType0Item] | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branching_rules(data: object) -> list[GetFormResponse200PagesItemBranchingRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for branching_rules_type_0_item_data in (_branching_rules_type_0):
                    branching_rules_type_0_item = GetFormResponse200PagesItemBranchingRulesType0Item.from_dict(branching_rules_type_0_item_data)
                ...
                pass
            return cast(list[GetFormResponse200PagesItemBranchingRulesType0Item] | None, data)
        ...
        get_form_response_200_pages_item = cls(
            id=id,
        ...
        get_form_response_200_pages_item.additional_properties = d
        return get_form_response_200_pages_item

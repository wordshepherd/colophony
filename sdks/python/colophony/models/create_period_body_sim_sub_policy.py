...
from ..models.create_period_body_sim_sub_policy_type import CreatePeriodBodySimSubPolicyType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.create_period_body_sim_sub_policy_genre_overrides_item import (
        CreatePeriodBodySimSubPolicyGenreOverridesItem,
    )


T = TypeVar("T", bound="CreatePeriodBodySimSubPolicy")


@_attrs_define
class CreatePeriodBodySimSubPolicy:
    """Sim-sub policy (default: allowed)

    Attributes:
        type_ (CreatePeriodBodySimSubPolicyType):
        notify_window_hours (int | Unset):
        genre_overrides (list[CreatePeriodBodySimSubPolicyGenreOverridesItem] | Unset):
        notes (str | Unset):
    """

    type_: CreatePeriodBodySimSubPolicyType
    notify_window_hours: int | Unset = UNSET
    genre_overrides: list[CreatePeriodBodySimSubPolicyGenreOverridesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = CreatePeriodBodySimSubPolicyType(d.pop("type"))
        ...
        if _genre_overrides is not UNSET:
            ...
            for genre_overrides_item_data in _genre_overrides:
                genre_overrides_item = CreatePeriodBodySimSubPolicyGenreOverridesItem.from_dict(
        ...
        create_period_body_sim_sub_policy = cls(
            type_=type_,
        ...
        create_period_body_sim_sub_policy.additional_properties = d
        return create_period_body_sim_sub_policy

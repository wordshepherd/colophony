...
if TYPE_CHECKING:
    from ..models.duplicate_form_response_201_pages_item_branching_rules_type_0_item import (
...
class DuplicateFormResponse201PagesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branching_rules(
            data: object,
        ) -> list[DuplicateFormResponse201PagesItemBranchingRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for branching_rules_type_0_item_data in _branching_rules_type_0:
                    branching_rules_type_0_item = DuplicateFormResponse201PagesItemBranchingRulesType0Item.from_dict(

...
T = TypeVar("T", bound="ReorderCollectionItemsResponse200Item")


@_attrs_define
class ReorderCollectionItemsResponse200Item:
    """
    Attributes:
        id (UUID): Item ID
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reorder_collection_items_response_200_item = cls(
            id=id,
        ...
        reorder_collection_items_response_200_item.additional_properties = d
        return reorder_collection_items_response_200_item

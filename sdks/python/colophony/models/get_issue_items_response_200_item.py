...
T = TypeVar("T", bound="GetIssueItemsResponse200Item")



@_attrs_define
class GetIssueItemsResponse200Item:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_issue_items_response_200_item = cls(
            id=id,
            issue_id=issue_id,
        ...
        get_issue_items_response_200_item.additional_properties = d
        return get_issue_items_response_200_item

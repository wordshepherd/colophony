...
from ..models.generate_contract_response_201_status import GenerateContractResponse201Status

if TYPE_CHECKING:
    from ..models.generate_contract_response_201_merge_data_type_0 import GenerateContractResponse201MergeDataType0


T = TypeVar("T", bound="GenerateContractResponse201")


@_attrs_define
class GenerateContractResponse201:
    """
    Attributes:
        id (UUID): Contract ID
        ...
        status (GenerateContractResponse201Status): Current status of the contract
        rendered_body (str): Contract body with merge fields resolved
        merge_data (GenerateContractResponse201MergeDataType0 | None): Merge field values used
    ...
    status: GenerateContractResponse201Status
    rendered_body: str
    merge_data: GenerateContractResponse201MergeDataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.merge_data, GenerateContractResponse201MergeDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GenerateContractResponse201Status(d.pop("status"))

        rendered_body = d.pop("renderedBody")

        def _parse_merge_data(data: object) -> GenerateContractResponse201MergeDataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                merge_data_type_0 = GenerateContractResponse201MergeDataType0.from_dict(data)

                return merge_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GenerateContractResponse201MergeDataType0 | None, data)
        ...
        generate_contract_response_201 = cls(
            id=id,
        ...
        generate_contract_response_201.additional_properties = d
        return generate_contract_response_201

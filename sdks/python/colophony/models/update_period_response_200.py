...
from ..models.update_period_response_200_blind_review_mode import UpdatePeriodResponse200BlindReviewMode

if TYPE_CHECKING:
    from ..models.update_period_response_200_sim_sub_policy import UpdatePeriodResponse200SimSubPolicy


T = TypeVar("T", bound="UpdatePeriodResponse200")


@_attrs_define
class UpdatePeriodResponse200:
    """
    Attributes:
        ...
        sim_sub_policy (UpdatePeriodResponse200SimSubPolicy): Sim-sub policy for this period
        blind_review_mode (UpdatePeriodResponse200BlindReviewMode): Blind review mode for the submission period
    ...
    sim_sub_policy: UpdatePeriodResponse200SimSubPolicy
    blind_review_mode: UpdatePeriodResponse200BlindReviewMode
    is_contest: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sim_sub_policy = UpdatePeriodResponse200SimSubPolicy.from_dict(d.pop("simSubPolicy"))

        blind_review_mode = UpdatePeriodResponse200BlindReviewMode(d.pop("blindReviewMode"))
        ...
        update_period_response_200 = cls(
            id=id,
        ...
        update_period_response_200.additional_properties = d
        return update_period_response_200

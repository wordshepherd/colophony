...
from ..models.publish_issue_response_200_status import PublishIssueResponse200Status
...
if TYPE_CHECKING:
  from ..models.publish_issue_response_200_metadata_type_0 import PublishIssueResponse200MetadataType0





T = TypeVar("T", bound="PublishIssueResponse200")



@_attrs_define
class PublishIssueResponse200:
    """ 
        Attributes:
            id (UUID): Issue ID
            ...
            status (PublishIssueResponse200Status): Current status of the issue
            ...
            metadata (None | PublishIssueResponse200MetadataType0): Metadata
    ...
    status: PublishIssueResponse200Status
    publication_date: datetime.datetime | None
    published_at: datetime.datetime | None
    metadata: None | PublishIssueResponse200MetadataType0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, PublishIssueResponse200MetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PublishIssueResponse200Status(d.pop("status"))
        ...
        def _parse_metadata(data: object) -> None | PublishIssueResponse200MetadataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = PublishIssueResponse200MetadataType0.from_dict(data)
                ...
                pass
            return cast(None | PublishIssueResponse200MetadataType0, data)
        ...
        publish_issue_response_200 = cls(
            id=id,
        ...
        publish_issue_response_200.additional_properties = d
        return publish_issue_response_200

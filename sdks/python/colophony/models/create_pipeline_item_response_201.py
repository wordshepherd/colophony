...
class CreatePipelineItemResponse201:
    ...
    stage: CreatePipelineItemResponse201Stage
    ...
    submission: CreatePipelineItemResponse201Submission | Unset = UNSET
    publication: CreatePipelineItemResponse201Publication | Unset = UNSET
    assigned_copyeditor: CreatePipelineItemResponse201AssignedCopyeditor | Unset = UNSET

...
from ..models.update_submission_status_response_200_submission_status import (
    UpdateSubmissionStatusResponse200SubmissionStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_submission_status_response_200_submission_form_data_type_0 import (
        UpdateSubmissionStatusResponse200SubmissionFormDataType0,
    )
    from ..models.update_submission_status_response_200_submission_sim_sub_policy_requirement_type_0 import (
...
class UpdateSubmissionStatusResponse200Submission:
    ...
    Attributes:
        ...
        sim_sub_policy_requirement (None | Unset |
            UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0): Policy requirement recorded when sim-
            sub conflict detected under allowed_notify/allowed_withdraw
    """
    ...
    sim_sub_policy_requirement: (
        None | Unset | UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.sim_sub_policy_requirement, Unset):
            ...
            self.sim_sub_policy_requirement, UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0
        ):
        ...
        def _parse_sim_sub_policy_requirement(
            ...
            try:
                ...
                sim_sub_policy_requirement_type_0 = (
                    UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0.from_dict(data)
                )

                return sim_sub_policy_requirement_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | Unset | UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0, data)

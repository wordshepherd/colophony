...
from ..models.create_period_response_201_blind_review_mode import CreatePeriodResponse201BlindReviewMode

if TYPE_CHECKING:
    from ..models.create_period_response_201_sim_sub_policy import CreatePeriodResponse201SimSubPolicy


T = TypeVar("T", bound="CreatePeriodResponse201")


@_attrs_define
class CreatePeriodResponse201:
    """
    Attributes:
        ...
        sim_sub_policy (CreatePeriodResponse201SimSubPolicy): Sim-sub policy for this period
        blind_review_mode (CreatePeriodResponse201BlindReviewMode): Blind review mode for the submission period
    ...
    sim_sub_policy: CreatePeriodResponse201SimSubPolicy
    blind_review_mode: CreatePeriodResponse201BlindReviewMode
    is_contest: bool
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sim_sub_policy = CreatePeriodResponse201SimSubPolicy.from_dict(d.pop("simSubPolicy"))

        blind_review_mode = CreatePeriodResponse201BlindReviewMode(d.pop("blindReviewMode"))
        ...
        create_period_response_201 = cls(
            id=id,
        ...
        create_period_response_201.additional_properties = d
        return create_period_response_201

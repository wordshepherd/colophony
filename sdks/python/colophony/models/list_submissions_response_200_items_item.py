...
from ..models.list_submissions_response_200_items_item_status import ListSubmissionsResponse200ItemsItemStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_submissions_response_200_items_item_form_data_type_0 import (
        ListSubmissionsResponse200ItemsItemFormDataType0,
    )
    from ..models.list_submissions_response_200_items_item_sim_sub_policy_requirement_type_0 import (
        ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0,
    )


T = TypeVar("T", bound="ListSubmissionsResponse200ItemsItem")


@_attrs_define
class ListSubmissionsResponse200ItemsItem:
    """
    Attributes:
        ...
        form_data (ListSubmissionsResponse200ItemsItemFormDataType0 | None): Structured form data keyed by field key
        manuscript_version_id (None | UUID): ID of the manuscript version attached to this submission
        status (ListSubmissionsResponse200ItemsItemStatus): Current status in the submission workflow
        ...
        sim_sub_policy_requirement (ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0 | None | Unset):
    ...
    form_data: ListSubmissionsResponse200ItemsItemFormDataType0 | None
    manuscript_version_id: None | UUID
    status: ListSubmissionsResponse200ItemsItemStatus
    submitted_at: datetime.datetime | None
    created_at: datetime.datetime
    updated_at: datetime.datetime
    sim_sub_policy_requirement: ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_data, ListSubmissionsResponse200ItemsItemFormDataType0):
        ...
        if isinstance(self.sim_sub_policy_requirement, Unset):
            ...
            self.sim_sub_policy_requirement, ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_data(data: object) -> ListSubmissionsResponse200ItemsItemFormDataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                form_data_type_0 = ListSubmissionsResponse200ItemsItemFormDataType0.from_dict(data)

                return form_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ListSubmissionsResponse200ItemsItemFormDataType0 | None, data)
        ...
        status = ListSubmissionsResponse200ItemsItemStatus(d.pop("status"))
        ...
        def _parse_sim_sub_policy_requirement(
            data: object,
        ) -> ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0 | None | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                sim_sub_policy_requirement_type_0 = (
                    ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0.from_dict(data)
                )

                return sim_sub_policy_requirement_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ListSubmissionsResponse200ItemsItemSimSubPolicyRequirementType0 | None | Unset, data)

        sim_sub_policy_requirement = _parse_sim_sub_policy_requirement(d.pop("simSubPolicyRequirement", UNSET))

        list_submissions_response_200_items_item = cls(
            id=id,
        ...
        list_submissions_response_200_items_item.additional_properties = d
        return list_submissions_response_200_items_item

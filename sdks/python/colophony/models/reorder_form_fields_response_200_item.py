...
class ReorderFormFieldsResponse200Item:
    ...
    field_key: str
    field_type: ReorderFormFieldsResponse200ItemFieldType
    label: str
    description: None | str
    placeholder: None | str
    required: bool
    sort_order: int
    config: None | ReorderFormFieldsResponse200ItemConfigType0
    conditional_rules: list[ReorderFormFieldsResponse200ItemConditionalRulesType0Item] | None
    branch_id: None | str
    page_id: None | UUID
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, ReorderFormFieldsResponse200ItemConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> None | ReorderFormFieldsResponse200ItemConfigType0:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(None | ReorderFormFieldsResponse200ItemConfigType0, data)
        ...
        def _parse_conditional_rules(data: object) -> list[ReorderFormFieldsResponse200ItemConditionalRulesType0Item] | None:
            ...
            try:
                ...
                pass
            return cast(list[ReorderFormFieldsResponse200ItemConditionalRulesType0Item] | None, data)

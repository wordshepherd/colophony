...
from ..models.resubmit_submission_response_200_submission_sim_sub_policy_requirement_type_0_type import (
    ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0")


@_attrs_define
class ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        resubmit_submission_response_200_submission_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        resubmit_submission_response_200_submission_sim_sub_policy_requirement_type_0.additional_properties = d
        return resubmit_submission_response_200_submission_sim_sub_policy_requirement_type_0

...
from ..models.remove_form_field_response_200_conditional_rules_type_0_item_condition_operator import (
    RemoveFormFieldResponse200ConditionalRulesType0ItemConditionOperator,
)

if TYPE_CHECKING:
    from ..models.remove_form_field_response_200_conditional_rules_type_0_item_condition_rules_item import (
...
class RemoveFormFieldResponse200ConditionalRulesType0ItemCondition:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for rules_item_data in _rules:
            rules_item = RemoveFormFieldResponse200ConditionalRulesType0ItemConditionRulesItem.from_dict(
                rules_item_data
            )

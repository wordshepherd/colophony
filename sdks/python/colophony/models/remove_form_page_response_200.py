...
class RemoveFormPageResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branching_rules(data: object) -> list[RemoveFormPageResponse200BranchingRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(list[RemoveFormPageResponse200BranchingRulesType0Item] | None, data)

...
class WithdrawSubmissionResponse200Submission:
    ...
    form_data: None | WithdrawSubmissionResponse200SubmissionFormDataType0
    manuscript_version_id: None | UUID
    status: WithdrawSubmissionResponse200SubmissionStatus
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_data, WithdrawSubmissionResponse200SubmissionFormDataType0):

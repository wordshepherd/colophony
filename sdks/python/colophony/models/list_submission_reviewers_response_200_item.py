...
from ..models.list_submission_reviewers_response_200_item_reviewer_role import (
    ListSubmissionReviewersResponse200ItemReviewerRole,
)

T = TypeVar("T", bound="ListSubmissionReviewersResponse200Item")


@_attrs_define
class ListSubmissionReviewersResponse200Item:
    """
    Attributes:
        id (UUID):
        submission_id (UUID):
        ...
        reviewer_role (ListSubmissionReviewersResponse200ItemReviewerRole):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reviewer_role = ListSubmissionReviewersResponse200ItemReviewerRole(d.pop("reviewerRole"))
        ...
        list_submission_reviewers_response_200_item = cls(
            id=id,
        ...
        list_submission_reviewers_response_200_item.additional_properties = d
        return list_submission_reviewers_response_200_item

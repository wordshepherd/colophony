...
from ..models.update_submission_response_200_status import UpdateSubmissionResponse200Status
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_submission_response_200_form_data_type_0 import UpdateSubmissionResponse200FormDataType0
    from ..models.update_submission_response_200_sim_sub_policy_requirement_type_0 import (
        UpdateSubmissionResponse200SimSubPolicyRequirementType0,
    )


T = TypeVar("T", bound="UpdateSubmissionResponse200")


@_attrs_define
class UpdateSubmissionResponse200:
    """
    Attributes:
        ...
        form_data (None | UpdateSubmissionResponse200FormDataType0): Structured form data keyed by field key
        manuscript_version_id (None | UUID): ID of the manuscript version attached to this submission
        status (UpdateSubmissionResponse200Status): Current status in the submission workflow
        ...
        sim_sub_policy_requirement (None | Unset | UpdateSubmissionResponse200SimSubPolicyRequirementType0): Policy
    ...
    form_data: None | UpdateSubmissionResponse200FormDataType0
    manuscript_version_id: None | UUID
    status: UpdateSubmissionResponse200Status
    submitted_at: datetime.datetime | None
    created_at: datetime.datetime
    updated_at: datetime.datetime
    sim_sub_policy_requirement: None | Unset | UpdateSubmissionResponse200SimSubPolicyRequirementType0 = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_data, UpdateSubmissionResponse200FormDataType0):
        ...
        elif isinstance(self.sim_sub_policy_requirement, UpdateSubmissionResponse200SimSubPolicyRequirementType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_data(data: object) -> None | UpdateSubmissionResponse200FormDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                form_data_type_0 = UpdateSubmissionResponse200FormDataType0.from_dict(data)

                return form_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | UpdateSubmissionResponse200FormDataType0, data)
        ...
        status = UpdateSubmissionResponse200Status(d.pop("status"))
        ...
        def _parse_sim_sub_policy_requirement(
            data: object,
        ) -> None | Unset | UpdateSubmissionResponse200SimSubPolicyRequirementType0:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                sim_sub_policy_requirement_type_0 = UpdateSubmissionResponse200SimSubPolicyRequirementType0.from_dict(
                    data
                )
                ...
                pass
            return cast(None | Unset | UpdateSubmissionResponse200SimSubPolicyRequirementType0, data)

        sim_sub_policy_requirement = _parse_sim_sub_policy_requirement(d.pop("simSubPolicyRequirement", UNSET))

        update_submission_response_200 = cls(
            id=id,
        ...
        update_submission_response_200.additional_properties = d
        return update_submission_response_200

...
from ..models.create_issue_response_201_status import CreateIssueResponse201Status
...
if TYPE_CHECKING:
  from ..models.create_issue_response_201_metadata_type_0 import CreateIssueResponse201MetadataType0





T = TypeVar("T", bound="CreateIssueResponse201")



@_attrs_define
class CreateIssueResponse201:
    """ 
        Attributes:
            id (UUID): Issue ID
            ...
            status (CreateIssueResponse201Status): Current status of the issue
            ...
            metadata (CreateIssueResponse201MetadataType0 | None): Metadata
    ...
    status: CreateIssueResponse201Status
    publication_date: datetime.datetime | None
    published_at: datetime.datetime | None
    metadata: CreateIssueResponse201MetadataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, CreateIssueResponse201MetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateIssueResponse201Status(d.pop("status"))
        ...
        def _parse_metadata(data: object) -> CreateIssueResponse201MetadataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = CreateIssueResponse201MetadataType0.from_dict(data)
                ...
                pass
            return cast(CreateIssueResponse201MetadataType0 | None, data)
        ...
        create_issue_response_201.additional_properties = d
        return create_issue_response_201

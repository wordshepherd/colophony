...
if TYPE_CHECKING:
  from ..models.add_form_page_response_201_branching_rules_type_0_item import AddFormPageResponse201BranchingRulesType0Item





T = TypeVar("T", bound="AddFormPageResponse201")



@_attrs_define
class AddFormPageResponse201:
    """ 
        Attributes:
            id (UUID):
            ...
            sort_order (int):
            branching_rules (list[AddFormPageResponse201BranchingRulesType0Item] | None):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_branching_rules(data: object) -> list[AddFormPageResponse201BranchingRulesType0Item] | None:
            if data is None:
                return data
            try:
                ...
                for branching_rules_type_0_item_data in (_branching_rules_type_0):
                    branching_rules_type_0_item = AddFormPageResponse201BranchingRulesType0Item.from_dict(branching_rules_type_0_item_data)
                ...
                pass
            return cast(list[AddFormPageResponse201BranchingRulesType0Item] | None, data)
        ...
        add_form_page_response_201 = cls(
            id=id,
        ...
        add_form_page_response_201.additional_properties = d
        return add_form_page_response_201

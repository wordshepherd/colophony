...
if TYPE_CHECKING:
    from ..models.add_form_page_response_201_branching_rules_type_0_item import (
        ...
        def _parse_branching_rules(data: object) -> list[AddFormPageResponse201BranchingRulesType0Item] | None:
            ...
            try:
                ...
                for branching_rules_type_0_item_data in _branching_rules_type_0:
                    branching_rules_type_0_item = AddFormPageResponse201BranchingRulesType0Item.from_dict(

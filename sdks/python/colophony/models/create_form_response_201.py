...
from ..models.create_form_response_201_status import CreateFormResponse201Status
...
T = TypeVar("T", bound="CreateFormResponse201")



@_attrs_define
class CreateFormResponse201:
    """ 
        Attributes:
            ...
            status (CreateFormResponse201Status): Current status of the form definition
    ...
    status: CreateFormResponse201Status
    version: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateFormResponse201Status(d.pop("status"))
        ...
        create_form_response_201.additional_properties = d
        return create_form_response_201

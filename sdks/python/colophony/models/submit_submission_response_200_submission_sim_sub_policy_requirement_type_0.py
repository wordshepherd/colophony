...
from ..models.submit_submission_response_200_submission_sim_sub_policy_requirement_type_0_type import (
    SubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="SubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0")


@_attrs_define
class SubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (SubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = SubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        submit_submission_response_200_submission_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        submit_submission_response_200_submission_sim_sub_policy_requirement_type_0.additional_properties = d
        return submit_submission_response_200_submission_sim_sub_policy_requirement_type_0

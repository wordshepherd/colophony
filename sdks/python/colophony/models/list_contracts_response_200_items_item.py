...
from ..models.list_contracts_response_200_items_item_status import ListContractsResponse200ItemsItemStatus

if TYPE_CHECKING:
    from ..models.list_contracts_response_200_items_item_merge_data_type_0 import (
        ListContractsResponse200ItemsItemMergeDataType0,
    )


T = TypeVar("T", bound="ListContractsResponse200ItemsItem")


@_attrs_define
class ListContractsResponse200ItemsItem:
    """
    Attributes:
        id (UUID): Contract ID
        ...
        status (ListContractsResponse200ItemsItemStatus): Current status of the contract
        rendered_body (str): Contract body with merge fields resolved
        merge_data (ListContractsResponse200ItemsItemMergeDataType0 | None): Merge field values used
    ...
    status: ListContractsResponse200ItemsItemStatus
    rendered_body: str
    merge_data: ListContractsResponse200ItemsItemMergeDataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.merge_data, ListContractsResponse200ItemsItemMergeDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ListContractsResponse200ItemsItemStatus(d.pop("status"))

        rendered_body = d.pop("renderedBody")

        def _parse_merge_data(data: object) -> ListContractsResponse200ItemsItemMergeDataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                merge_data_type_0 = ListContractsResponse200ItemsItemMergeDataType0.from_dict(data)

                return merge_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(ListContractsResponse200ItemsItemMergeDataType0 | None, data)
        ...
        def _parse_countersigned_at(data: object) -> datetime.datetime | None:
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                countersigned_at_type_0 = datetime.datetime.fromisoformat(data)
        ...
        list_contracts_response_200_items_item = cls(
            id=id,
        ...
        list_contracts_response_200_items_item.additional_properties = d
        return list_contracts_response_200_items_item

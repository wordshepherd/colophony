...
T = TypeVar("T", bound="GetCollectionItemsResponse200Item")


@_attrs_define
class GetCollectionItemsResponse200Item:
    """
    Attributes:
        id (UUID): Item ID
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_collection_items_response_200_item = cls(
            id=id,
        ...
        get_collection_items_response_200_item.additional_properties = d
        return get_collection_items_response_200_item

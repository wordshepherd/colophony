...
from ..models.update_form_response_200_status import UpdateFormResponse200Status
...
T = TypeVar("T", bound="UpdateFormResponse200")



@_attrs_define
class UpdateFormResponse200:
    """ 
        Attributes:
            ...
            status (UpdateFormResponse200Status): Current status of the form definition
    ...
    status: UpdateFormResponse200Status
    version: int
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = UpdateFormResponse200Status(d.pop("status"))
        ...
        update_form_response_200.additional_properties = d
        return update_form_response_200

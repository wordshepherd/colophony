...
from ..models.archive_issue_response_200_status import ArchiveIssueResponse200Status
...
if TYPE_CHECKING:
  from ..models.archive_issue_response_200_metadata_type_0 import ArchiveIssueResponse200MetadataType0





T = TypeVar("T", bound="ArchiveIssueResponse200")



@_attrs_define
class ArchiveIssueResponse200:
    """ 
        Attributes:
            id (UUID): Issue ID
            ...
            status (ArchiveIssueResponse200Status): Current status of the issue
            ...
            metadata (ArchiveIssueResponse200MetadataType0 | None): Metadata
    ...
    status: ArchiveIssueResponse200Status
    publication_date: datetime.datetime | None
    published_at: datetime.datetime | None
    metadata: ArchiveIssueResponse200MetadataType0 | None
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.metadata, ArchiveIssueResponse200MetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ArchiveIssueResponse200Status(d.pop("status"))
        ...
        def _parse_metadata(data: object) -> ArchiveIssueResponse200MetadataType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0 = ArchiveIssueResponse200MetadataType0.from_dict(data)
                ...
                pass
            return cast(ArchiveIssueResponse200MetadataType0 | None, data)
        ...
        archive_issue_response_200 = cls(
            id=id,
        ...
        archive_issue_response_200.additional_properties = d
        return archive_issue_response_200

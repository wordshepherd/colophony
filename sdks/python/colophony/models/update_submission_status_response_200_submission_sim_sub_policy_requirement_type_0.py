...
from ..models.update_submission_status_response_200_submission_sim_sub_policy_requirement_type_0_type import (
    UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0")


@_attrs_define
class UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0:
    """
    Attributes:
        type_ (UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0Type):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = UpdateSubmissionStatusResponse200SubmissionSimSubPolicyRequirementType0Type(d.pop("type"))
        ...
        update_submission_status_response_200_submission_sim_sub_policy_requirement_type_0 = cls(
            type_=type_,
        ...
        update_submission_status_response_200_submission_sim_sub_policy_requirement_type_0.additional_properties = d
        return update_submission_status_response_200_submission_sim_sub_policy_requirement_type_0

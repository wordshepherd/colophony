...
if TYPE_CHECKING:
    from ..models.get_contract_template_response_200_merge_fields_type_0_item import (
        ...
        def _parse_merge_fields(data: object) -> list[GetContractTemplateResponse200MergeFieldsType0Item] | None:
            ...
            try:
                ...
                for merge_fields_type_0_item_data in _merge_fields_type_0:
                    merge_fields_type_0_item = GetContractTemplateResponse200MergeFieldsType0Item.from_dict(

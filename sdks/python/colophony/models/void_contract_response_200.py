...
from ..models.void_contract_response_200_status import VoidContractResponse200Status

if TYPE_CHECKING:
    from ..models.void_contract_response_200_merge_data_type_0 import VoidContractResponse200MergeDataType0


T = TypeVar("T", bound="VoidContractResponse200")


@_attrs_define
class VoidContractResponse200:
    """
    Attributes:
        id (UUID): Contract ID
        ...
        status (VoidContractResponse200Status): Current status of the contract
        rendered_body (str): Contract body with merge fields resolved
        merge_data (None | VoidContractResponse200MergeDataType0): Merge field values used
    ...
    status: VoidContractResponse200Status
    rendered_body: str
    merge_data: None | VoidContractResponse200MergeDataType0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.merge_data, VoidContractResponse200MergeDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = VoidContractResponse200Status(d.pop("status"))

        rendered_body = d.pop("renderedBody")

        def _parse_merge_data(data: object) -> None | VoidContractResponse200MergeDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                merge_data_type_0 = VoidContractResponse200MergeDataType0.from_dict(data)

                return merge_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | VoidContractResponse200MergeDataType0, data)
        ...
        void_contract_response_200 = cls(
            id=id,
        ...
        void_contract_response_200.additional_properties = d
        return void_contract_response_200

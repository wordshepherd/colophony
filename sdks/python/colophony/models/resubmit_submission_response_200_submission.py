...
from ..models.resubmit_submission_response_200_submission_status import ResubmitSubmissionResponse200SubmissionStatus
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.resubmit_submission_response_200_submission_form_data_type_0 import (
        ResubmitSubmissionResponse200SubmissionFormDataType0,
    )
    from ..models.resubmit_submission_response_200_submission_sim_sub_policy_requirement_type_0 import (
        ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0,
    )


T = TypeVar("T", bound="ResubmitSubmissionResponse200Submission")


@_attrs_define
class ResubmitSubmissionResponse200Submission:
    """
    Attributes:
        ...
        form_data (None | ResubmitSubmissionResponse200SubmissionFormDataType0): Structured form data keyed by field key
        manuscript_version_id (None | UUID): ID of the manuscript version attached to this submission
        status (ResubmitSubmissionResponse200SubmissionStatus): Current status in the submission workflow
        ...
        sim_sub_policy_requirement (None | ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0 | Unset):
    ...
    form_data: None | ResubmitSubmissionResponse200SubmissionFormDataType0
    manuscript_version_id: None | UUID
    status: ResubmitSubmissionResponse200SubmissionStatus
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.form_data, ResubmitSubmissionResponse200SubmissionFormDataType0):
        ...
        if isinstance(self.sim_sub_policy_requirement, Unset):
            ...
            self.sim_sub_policy_requirement, ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0
        ):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_form_data(data: object) -> None | ResubmitSubmissionResponse200SubmissionFormDataType0:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                form_data_type_0 = ResubmitSubmissionResponse200SubmissionFormDataType0.from_dict(data)

                return form_data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ResubmitSubmissionResponse200SubmissionFormDataType0, data)
        ...
        status = ResubmitSubmissionResponse200SubmissionStatus(d.pop("status"))
        ...
        def _parse_sim_sub_policy_requirement(
            data: object,
        ) -> None | ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0 | Unset:
            if data is None:
                return data
            ...
            try:
                ...
                sim_sub_policy_requirement_type_0 = (
                    ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0.from_dict(data)
                )

                return sim_sub_policy_requirement_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ResubmitSubmissionResponse200SubmissionSimSubPolicyRequirementType0 | Unset, data)

        sim_sub_policy_requirement = _parse_sim_sub_policy_requirement(d.pop("simSubPolicyRequirement", UNSET))

        resubmit_submission_response_200_submission = cls(
            id=id,
        ...
        resubmit_submission_response_200_submission.additional_properties = d
        return resubmit_submission_response_200_submission

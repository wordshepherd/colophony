...
- [x] [P3] Configure Zitadel webhook for staging — Actions → Targets → user event group → staging endpoint; automated in `pnpm zitadel:setup` with all 6 user lifecycle events — (DEVLOG 2026-03-20; done 2026-03-22)
